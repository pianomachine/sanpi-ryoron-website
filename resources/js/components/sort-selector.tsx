          ...
          {sortOptions.map((option) => (
            <label
              ...
              className={cn(
                ...
                localSort === option.value ? "text-foreground" : "text-muted-foreground/70 hover:text-muted-foreground"
              )}
            >
              ...
              {localSort === option.value && (
                ...
                >
                  <div className="absolute -top-[1px] left-1/2 -translate-x-1/2 w-8 h-[2px] bg-primary rounded-t-full">
